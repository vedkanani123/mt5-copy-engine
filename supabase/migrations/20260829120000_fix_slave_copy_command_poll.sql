-- Slaves must still receive COPY_OPEN / COPY_MODIFY / COPY_CLOSE while
-- copy trading is ON. The previous poll filter expired copy commands
-- correctly when OFF, then also skipped them when ON.
